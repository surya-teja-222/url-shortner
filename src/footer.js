...
function footer()
{
    return (
        <footer className="footer bg-c-very-dark-violet font-Poppins">
            <div className='flex flex-col justify-center content-center text-c-white pb-[56px]'>
                ...
                <div className='block m-auto mt-[52px]'>
                    <h1 className='text-center font-bold hover:text-c-cyan hover:cursor-pointer'>Features</h1>
                    <p  className='mt-[30px] text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Link Shortening</p>
                    <p  className='text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Branded Links</p>
                    <p  className='text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Analytics</p>
                </div>

                <div className='block m-auto mt-[52px]'>
                    <h1 className='text-center font-bold hover:text-c-cyan hover:cursor-pointer'>Resources</h1>
                    <p className=' mt-[30px] text-center  text-t-grey hover:text-c-cyan hover:cursor-pointer'>Blog</p>
                    <p className='text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Developers</p>
                    <p className='text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Support</p>
                </div>

                <div className='block m-auto mt-[52px]'>
                    <h1 className='text-center font-bold hover:text-c-cyan hover:cursor-pointer'>About</h1>
                    <p className='mt-[30px] text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Our Team</p>
                    <p className='text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Careers</p>
                    <p className='text-center text-t-grey hover:text-c-cyan hover:cursor-pointer'>Contact</p>
                </div>
